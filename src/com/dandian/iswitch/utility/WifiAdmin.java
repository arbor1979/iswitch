...
public class WifiAdmin {
	...
	public boolean testNetWork(WifiConfiguration configuration){
		int wcgId=mWifiManager.addNetwork(configuration);
		if(wcgId>-1)
			return true;
		else
	...
	public WifiConfiguration CreateWifiInfo(String SSID, String Password, int Type)     
	 ...
	 public int calculateSignalLevel(int level,int totalpercent)
	 {
		 return mWifiManager.calculateSignalLevel(level,100);
	 }
